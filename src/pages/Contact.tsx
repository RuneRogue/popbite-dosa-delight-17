        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-6 relative fancy-underline">Contact Information</h2>
                <div className="bg-white p-8 rounded-lg shadow-lg">
                  <div className="space-y-6">
                    <div className="flex items-start">
                      <div className="mr-4 text-popbite-orange">
                        <Mail size={24} />
                      </div>
                      <div>
                        <h3 className="font-semibold text-lg">Email</h3>
                        <p className="text-gray-600">hello@popbite.com</p>
                        <p className="text-gray-600">support@popbite.com</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="mr-4 text-popbite-orange">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex justify-center space-x-6">
              <a href="#" className="p-3 bg-popbite-orange text-white rounded-full hover:bg-popbite-red transition-colors">
